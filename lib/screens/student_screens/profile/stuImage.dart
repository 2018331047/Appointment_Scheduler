...
class _UserImageState extends State<UserImage> {
  ...
  //collecting studnets previous profile picture and exchanging with the new one
  String url =
...
//selecting the new image file to change profile picture
